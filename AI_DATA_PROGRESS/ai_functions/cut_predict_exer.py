# -*- coding: utf-8 -*-
"""
Created on Tue Aug 23 21:07:17 2022
...
def cut_predict(folder, filename):
    
    #folder = 'C:/Users/Yap/Downloads/Qompose.AI/splitAudio' 
    #file = 'demogecko.wav'
    #filename = 'demogecko.wav'
    
    swam = SplitWavAudioMubin(folder, filename) #splitwavaudiobin.py
    ...
    for i in range(0, total_dur, min_per_split):  #total duration is the duration of the audio uploaded
            ...
            spec = dss.preprocess(audio_file)
            predicted_keyword = dss.predict(audio_file) #prediction made by ai
...
if __name__ == "__main__":
    ...
    folder = 'E:/bengisu/1_ready_to_deploy' 
    filename = 'Grrrl, Uninterrupted_Ep 3_ Fly, Little Birdie, Fly.wav'
    cut_predict(folder, filename)
